...
export const addNewLecturer = catchAsyncErrors(async (req, res, next) => {
  if (!req.files || Object.keys(req.files).length === 0) {
    return next(new ErrorHandler("Lecturer Avatar Required!", 400));
  }
  ...
  if (!cloudinaryResponse || cloudinaryResponse.error) {
    ...
    return next(
      new ErrorHandler("Failed To Upload Lecturer Avatar To Cloudinary", 500)
    );
  }
...
export const getAllLecturers = catchAsyncErrors(async (req, res, next) => {
